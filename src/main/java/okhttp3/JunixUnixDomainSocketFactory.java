...
public final class JunixUnixDomainSocketFactory extends SocketFactory {
  private final File path;

  public JunixUnixDomainSocketFactory(File path) {
    this.path = path;
  }
  ...
  @Override public Socket createSocket() throws IOException {
    ...
    try {
      return new JunixTunnelingUnixSocket(AFUNIXSocketAddress.of(path), provider.openSocketChannel());
    } catch (Exception e) {
